...
@section('content')
    <main class="container px-4 py-8 mx-auto">
        ...
        <section class="p-8 mb-12 bg-white rounded-lg shadow-lg">
            ...
            <div class="grid grid-cols-1 gap-8 text-center md:grid-cols-3">
                <!-- Soil Temperature -->
                <div
                    class="p-8 transition-all transform rounded-lg shadow-md bg-gradient-to-br from-blue-50 to-blue-100 hover:scale-105">
                ...
                <!-- Soil Humidity -->
                <div
                    class="p-8 transition-all transform rounded-lg shadow-md bg-gradient-to-br from-green-50 to-green-100 hover:scale-105">
                ...
                <!-- Water Percentage -->
                <div
                    class="p-8 transition-all transform rounded-lg shadow-md bg-gradient-to-br from-purple-50 to-purple-100 hover:scale-105">
                    <span class="text-6xl">🚰</span>
            ...
            <div class="flex justify-center mt-8">
                <button
                    class="px-8 py-3 font-bold text-white transition-all transform rounded-full bg-gradient-to-r from-primary to-green-500 hover:from-green-600 hover:to-primary hover:scale-105"
    ...
    <script>
        function fetchSensorData() {
            ...
            document.getElementById('soil-temp').innerText = '22 °C';
            document.getElementById('soil-humidity').innerText = '28 %';
            ...
            fetch('/get-logs')
                ...
                .then(data => {
                    ...
                    list.innerHTML = activities.map(activity =>
                            `<li class='p-4 rounded-lg shadow-sm bg-gray-50'>${activity}</li>`)
                        .join('');
                });
        }
        ...
        function loadActivityLog() {
            ...
            const list = document.getElementById('activity-list');
            list.innerHTML = activities.map(activity => `<li class='p-4 rounded-lg shadow-sm bg-gray-50'>${activity}</li>`)
                .join('');
        }
